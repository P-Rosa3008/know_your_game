...
abstract class $AnswerCopyWith<$Res> {
  ...
  @useResult
  $Res call({String text, bool isTrue});
}
...
class _$_Answer implements _Answer {
  _$_Answer({required this.text, required this.isTrue});
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, text, isTrue);
...
abstract class _Answer implements Answer {
  factory _Answer({required final String text, required final bool isTrue}) =
      _$_Answer;
